...
function transform(code, options) {
  return babel.transformFileSync(code, {
...
describe('测试', function () {
  // it('重写', function () {
  //   const code = transform(`./test/a.js`);
  //   console.log(code)
  //   // assert.equal(code, `import Button from '@material-ui/core/Button';`);
  // });

  // it('重写', function () {
  //   const code = transform(`./test/b.js`);
  //   console.log(code)
  //   // assert.equal(code, `import Button from '@material-ui/core/Button';`);
  // });

  // it('重写', function () {
  //   const code = transform(`./test/c.js`);
  //   console.log(code)
  //   // assert.equal(code, `import Button from '@material-ui/core/Button';`);
  // });

  it('重写', function () {
    const code = transform(`./test/d.js`);
    console.log(code)
    // assert.equal(code, `import Button from '@material-ui/core/Button';`);
  });

  // it('重写', function () {
  //   const code = transform(`/Users/monsterstep/dev/sandbox2020/cube2/node_modules/react-draggable/dist/react-draggable.js`);
  //   console.log(code)
  //   // assert.equal(code, `import Button from '@material-ui/core/Button';`);
  // });
  ...
  // it('重写', function () {
  //   const code = transform(`/Users/monsterstep/dev/sandbox2020/cube2/client/modules/groups/components/group_picker_dialog.tsx`);
  //   console.log(code)
  //   // assert.equal(code, `import Button from '@material-ui/core/Button';`);
  // });

  // it('重写', function () {
    // const code = transform(`/Users/monsterstep/dev/sandbox2020/cube2/client/modules/common/components/carousel.tsx`);
    // console.log(code)
    // assert.equal(code, `import Button from '@material-ui/core/Button';`);
  // });

  // it('重写', function () {
  //   const code = transform(`/Users/monsterstep/dev/sandbox2020/cube2/client/modules/core/components/main_layout.jsx`);
  //   console.log(code)
  //   // assert.equal(code, `import Button from '@material-ui/core/Button';`);
  // });
});
